...
------------------------------------------------------------------------------*/  
    ...
    INNER JOIN sirketler s -- inner dedigimiz icin sadece ortak elemanlari gosterir.
...
from bolumler as b join personel as p
on b.bolum_id=p.bolum_id
where bolum_isim in('satis', 'muhasebe')
order by b.bolum_isim, p.personel_isim;

-- bağlama işi join'lerde on keyword'u ile yapilir.
