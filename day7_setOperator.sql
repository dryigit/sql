...
/* -----------------------------------------------------------------------------
  ORNEK3: Honda,Ford ve Tofas'ta çalisan personelin ismini listeleyin
------------------------------------------------------------------------------*/  

select isim 
from personel
where sirket ='honda'
union  -- union all yazarsak tekrarlanan isimleri de yazar
select isim 
from personel
where sirket ='ford' 
union 
...
/* -----------------------------------------------------------------------------
  ORNEK4: 5000’den az maas alanlarin bilgileri ile,  Honda calisani olmayanlarin bilgilerini alt alta
...
-- şirketlerden grupla sirketlerin calisan ismilerini say
