...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/        
   delete from ogrenciler where isim='nesibe yilmaz' or 'mustafa bak'; -- ilk yol
   delete from ogrenciler where isim in('nesibe yilmaz|mustafa bak'); -- ikinci yol. daha çok tercih edilir. 
